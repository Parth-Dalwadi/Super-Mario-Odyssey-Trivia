...
class Trivia:
    ...
    def result(self):
        ...
        stop_music()
        self.result_label = Label(root, text="Your final score was " + str(self.score) + "/" + str(len(self.questions)) + "!", width=30, bg="black", fg="lightblue", font=("Helvetica", 32, "bold"))
        ...
        self.result_label_percent = Label(root, text="(" + result_percent_split[0] + "%)", width=30, bg="black", fg="lightblue", font=("Helvetica", 16, "bold"))
